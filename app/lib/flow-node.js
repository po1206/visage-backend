/**
 * @author : milkisevil
 * @source : https://github.com/flowjs/flow.js/blob/master/samples/Node.js/flow-node.js
 */
var fs = require('fs'),
  path = require('path'),
  util = require('util'),
...
module.exports = flow = function (temporaryFolder) {
  ...
  function validateRequest(chunkNumber, chunkSize, totalSize, identifier, filename, fileSize) {
    ...
    if (typeof(fileSize) != 'undefined') {
      ...
      if (numberOfChunks >
        ...
        numberOfChunks &&
        fileSize !=
        ((totalSize % chunkSize) + parseInt(chunkSize))) {
  ...
  $.get = function (req, callback) {
    ...
    console.log(chunkNumber, chunkSize, totalSize, identifier, filename);
  ...
  $.post = function (req, callback) {
    ...
    var validation = validateRequest(chunkNumber,
      chunkSize,
      totalSize,
      identifier,
      filename,
    ...
    if (validation == 'valid') {
      ...
      fsExtra.move(files[$.fileParameterName].path, chunkFilename, function (err) {
        if (err) {
          console.log(err);
        }
